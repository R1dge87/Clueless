 ...
 * @generated
 */
public class NullPackageImpl extends EPackageImpl implements NullPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see Clueless.NullPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private NullPackageImpl() {
		super(eNS_URI, NullFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link NullPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static NullPackage init() {
		if (isInited) return (NullPackage)EPackage.Registry.INSTANCE.getEPackage(NullPackage.eNS_URI);

		// Obtain or create and register package
		NullPackageImpl theNullPackage = (NullPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof NullPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new NullPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theNullPackage.createPackageContents();

		// Initialize created meta-data
		theNullPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theNullPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(NullPackage.eNS_URI, theNullPackage);
		return theNullPackage;
	}
	 ...
	 * @generated
	 */
	public NullFactory getNullFactory() {
		return (NullFactory)getEFactoryInstance();
	}
