 ...
 * @generated
 */
public class NullSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static NullPackage modelPackage;
	...
	public NullSwitch() {
		if (modelPackage == null) {
			modelPackage = NullPackage.eINSTANCE;
		}
	}
